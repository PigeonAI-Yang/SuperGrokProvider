...
- Zcode configuration uses the locally verified `openai-compatible` schema with Grok Build's observed `low / medium / high / xhigh` Grok 4.5 variants and `high` default.
