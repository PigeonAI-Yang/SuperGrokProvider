...
| --- | --- | --- |
| Accounts | Add, authorize, rename, inspect models, select, reset and delete isolated Grok accounts | `/api/accounts`, `/api/accounts/{id}/rename`, `/api/accounts/{id}/models` |
