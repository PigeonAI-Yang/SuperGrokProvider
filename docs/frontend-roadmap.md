...
- [x] Freeze official OAuth and profile isolation boundary.
- [x] Close account add/authorize/list/delete loop.
- [x] Close provider forwarding and automatic rotation loop.
- [x] Close fixed-height settings, pagination and details drawer UI loop.
